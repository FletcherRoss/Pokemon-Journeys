...
if page == "🏠 Home":
    ...
    render()
elif page == "⚔️ Gauntlet":
    from pages.gauntlet import render
    render()
elif page == "🗺️ Story Mode":
    from pages.story_mode import render
    render()
elif page == "👑 Elite Four":
    from pages.elite_four import render
    render()
